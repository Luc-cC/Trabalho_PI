...
if(isset($_POST['excluir_ebook'])){
    
    $sql = "DELETE id_ebook,id_usuario,id_autor,id_editora,titulo_ebook,valor_ebook,link_ebook FROM ebook.tb_ebook WHERE id_ebook";
...
<td><?php echo "<input type ='submit' id = 'excluir_ebook' name = 'excluir_ebook' value = 'Excluir'>"; ?></td> 
<td><?php echo "<input type ='submit' id = 'editar_ebook' name = 'editar_ebook' value = 'Editar'>"; ?></td> 
<?php } ?>
<?php } ?>
